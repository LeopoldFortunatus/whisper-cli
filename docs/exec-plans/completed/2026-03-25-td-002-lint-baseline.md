...
- Качество документации и `build-contract` синхронизировано: `make lint` задокументирован, `make ci` проверяет `lint` автоматически, `TD-002` закрыт.
